<div class="container">
    <div class="card shadow my-2">
        <div class="card-head primary_bg">
            <h5 class="mx-2 text-white">TRANSACTION HISTORY</h5>
        </div>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header primary_bg">
                <h5 class="modal-title text-white" id="modalTitleId">ITEM HISTORY DETAILS</h5>
...
<script>
    ...
    function fetchDetails(item_id) {
        $.post("admin_pages/transactionhistory/components/viewAuctionDetail.php", {
                item_id
            },
            function(data) {
