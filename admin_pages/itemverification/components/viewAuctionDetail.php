                ...
                <div class="row">
                    <div class="row">
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    <td> <button onclick="approveAuction()" class="btn primary_bg form-control text-white">Post Auction</button></td>
                                    <td> <button onclick="denyAuction()" class="btn btn-danger form-control text-white">Deny Auction</button></td>
