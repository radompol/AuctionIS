...
<div class="container my-3 ">
    <h3>MY <span class="primary_text">Bids</span></h3>
...
<div id="mybids_display" class="container">
    <!-- CONTENTS HERE -->
</div>
...
<script>
    ...
    function fetchmybidsData() {

        $.post("pages/mybids/components/fetchmybidlist.php", {

            },
            function(data) {
                $('#mybids_display').html(data)
            }
