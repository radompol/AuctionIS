              ...
              <div class="card-body bg-light">
                  <div class="row ">
                      ...
                      <div class="col-sm-12 col-md-4 col-lg-2 ">
                          ...
                          <button onclick="viewhandler_myAuction('5')" class="btn primary_bg m-2 rounded-pill text-white btn_set form-control">View Bid</button>
                      </div>
                  </div>
              ...
              <div class="card-body bg-light">
                  <div class="row ">
                      ...
                      <div class="col-sm-12 col-md-4 col-lg-2 ">
                          ...
                          <?php if (true) : ?>
                              <button onclick="viewhandler_myAuction('5')" class="btn btn-danger m-2 rounded-pill text-white btn_set form-control" disabled>Cancelled</button>
  ...
  <script>
      ...
      function viewhandler_myAuction(item_id) {
          ...
          $.post("pages/mybids/components/viewAuction.php", {
                  item_id,
